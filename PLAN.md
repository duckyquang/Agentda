...
- ⏳ the bot reads a real mailbox through the starter email recipe — the server is built and its config guard tested; verifying the IMAP path needs real mailbox credentials.
